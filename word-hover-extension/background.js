...
if (typeof CONFIG === 'undefined' || !CONFIG.GEMINI_API_KEY) {
  console.error('❌ Error: CONFIG.GEMINI_API_KEY not found. Please run "npm run build" to generate config.js from .env');
}
...
async function testAPIConnectivity() {
  ...
  try {
    ...
    if (!apiKey) {
      console.error('❌ API key not configured. Please run "npm run build" to generate config.js');
      return;
    }
